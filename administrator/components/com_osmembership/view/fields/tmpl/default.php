...
<div id="editcell">
	...
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHtml::_('grid.sort',  'OSM_NAME', 'tbl.name', $this->state->filter_order_Dir, $this->state->filter_order); ?>
			</th>
			<th class="title">
				<?php echo JHtml::_('grid.sort',  'OSM_TITLE', 'tbl.title', $this->state->filter_order_Dir, $this->state->filter_order); ?>
			</th>
			<th class="title">
				<?php echo JHtml::_('grid.sort',  'OSM_FIELD_TYPE', 'tbl.field_type', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
			</th>			
			<th class="title center">
				<?php echo JHtml::_('grid.sort',  'OSM_CORE_FIELD', 'tbl.is_core', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
			</th>
			<th class="title center">
				<?php echo JHtml::_('grid.sort',  'OSM_PUBLISHED', 'tbl.published', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
			</th>			
			<th width="8%" nowrap="nowrap">
				<?php echo JHtml::_('grid.sort',  'Order', 'tbl.ordering', $this->state->filter_order_Dir, $this->state->filter_order ); ?>
