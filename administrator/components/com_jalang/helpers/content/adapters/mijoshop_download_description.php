...
if(JFile::exists(JPATH_ADMINISTRATOR . '/components/com_mijoshop/mijoshop.php')) {
	...
	JalangHelperContent::registerAdapter(
		__FILE__,
		'mijoshop_download_description',
		3,
		JText::_('MIJOSHOP_DOWNLOAD'),
		JText::_('MIJOSHOP_DOWNLOAD')
	);
	...
	class JalangHelperContentMijoshopDownloadDescription extends JalangHelperContent
	{
		...
		public function getEditLink($id) {
			return 'index.php?option=com_mijoshop&route=catalog/download/'.$this->mijoshop_type.'&download_id='.$id;
		}
		...
		{
			return array(
				'a.download_id' => 'JGRID_HEADING_ID',
