...
var JADependForm = new Class({ 	
	...
	enable: function (el) {
		...
		this.closest(el, '.config-option-list > li, div.control-group').setStyle('display', 'block');
	},
	
	disable: function (el) {
		el._disabled = true; //selector 'li' is J2.5 compactible
		this.closest(el, '.config-option-list > li, div.control-group').setStyle('display', 'none');
	},
