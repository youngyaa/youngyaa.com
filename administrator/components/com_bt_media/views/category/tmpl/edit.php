...
<form action="<?php echo JRoute::_('index.php?option=com_bt_media&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="category-form" class="form-validate" style="display: block;">
    <fieldset class="adminform">
        <div id="tabs">
            <ul>
                <li class="active"><a href="#details"><?php echo JText::_('COM_BT_MEDIA_CATEGORY_LEGEND_CATEGORY'); ?></a></li>
            ...
            <div id="details" class="tab-pane active">
                <ul class="adminformlist">
                    ...
                    <li><?php echo $this->form->getLabel('category_image'); ?>
                        <?php echo $this->form->getInput('category_image'); ?></li>
