 ...
 */
class Bt_mediaViewTags extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        if ($this->legacy) {
            ...
            Bt_mediaHelper::addSubmenu('tags');
            $this->addToolbar();
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_BT_MEDIA_MENU_TAG_TITLE'), 'tags.png');
        ...
        if (!$this->legacy) {
            JHtmlSidebar::setAction('index.php?option=com_bt_media&view=tags');
