 ...
 */
class JFormFieldVimeoUsername extends JFormField
{
	/**
	 * The form field type.
	 *
                        ...
                        $BM(document).ready(function() {
                            $BM("#'.$this->id.'").blur(function(){
                                ...
                                if(uname != ""){
                                    ...
                                    $BM("#tabs-8 li.message-display").addClass("error").html("Please input Vimeo User ID").fadeIn(1000);
                                }
                            });
                        });
                    </script>
