 ...
 */
class Bt_mediaModelcategories extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        //Filtering parent
        $this->setState('filter.parent', $app->getUserStateFromRequest($this->context . '.filter.parent', 'filter_parent', '', 'string'));
    ...
    protected function getListQuery() {
        ...
        if ($parent) {
            $query->where('a.parent_id = ' . $parent);
        }
