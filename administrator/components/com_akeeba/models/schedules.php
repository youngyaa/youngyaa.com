...
class AkeebaModelSchedules extends F0FModel
{
	...
	public function getPaths()
	{
		...
		$ret->info->secret    = $this->params->get('frontend_secret_word', '');
		$ret->info->feenabled = $this->params->get('frontend_enable', false);
		// Get root URL
		$ret->info->root_url = rtrim($this->params->get('siteurl', ''), '/');
	...
	public function getCheckPaths()
	{
		...
		// Get front-end backup secret key
		$ret->info->secret    = $this->params->get('frontend_secret_word', '');
		$ret->info->feenabled = $this->params->get('failure_frontend_enable', false);
		// Get root URL
		$ret->info->root_url = rtrim($this->params->get('siteurl', ''), '/');
