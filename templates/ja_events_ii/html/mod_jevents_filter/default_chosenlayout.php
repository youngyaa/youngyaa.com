			...
			case "ful":
				...
				<ul class="<?php echo $params->get("filterlayout", "vt")=="ul"?"jevfilterlist":"jevfilterfloatlist";?>" >
					...
					<li class="btn-actions">
						<label>&nbsp;</label>
						<div class="jevfilterinput">
						<input class="modfilter_button btn btn-default" type="button" onclick="JeventsFilters.reset(this.form)" value="<?php echo JText::_('RESET'); ?>" />
						<?php 	if ($params->get("showlabels", 1)) {?>
						</div>
						<div class="jevfilterinput">
						<?php } ?>
						<input class="modfilter_button btn btn-primary" type="submit" value="<?php echo JText::_('ok'); ?>" name="jevents_filter_submit" />
						</div>
					</li>
				</ul>
				<?php
