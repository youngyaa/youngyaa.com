		...
		if( $this->minical_showlink ){
			...
			if( $this->minical_showlink == 1 ){
				...
				if( $this->minical_prevyear ){
					$content .= $this->monthYearNavigation($basefirst_of_month,"-1 year",'<i class="fa fa-angle-double-left"></i>',JText::_('JEV_CLICK_TOSWITCH_PY'));
				}
				...
				if( $this->minical_prevmonth ){
					...
					$content .= $this->monthYearNavigation($basefirst_of_month,"-1 month",'<i class="fa fa-angle-left"></i>',JText::_('JEV_CLICK_TOSWITCH_PM'));
				}
				...
				if( $this->minical_nextmonth ){
					...
					$content .= $this->monthYearNavigation($basefirst_of_month,"+1 month",'<i class="fa fa-angle-right"></i>',JText::_('JEV_CLICK_TOSWITCH_NM'));
				}

				if( $this->minical_nextyear ){
					$content .= $this->monthYearNavigation($basefirst_of_month,"+1 year",'<i class="fa fa-angle-double-right"></i>',JText::_('JEV_CLICK_TOSWITCH_NY'));
				}
