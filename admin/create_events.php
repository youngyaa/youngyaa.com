...
echo "<script>alert('Image Not Uploaded');window.location.href='create_events.php';</script>";
									exit;
									return;
...
$insert=$mysqlipre->query("INSERT INTO ` a7rtg_myevents`(`title`,`description`,`image`,`created_date`,`insertime`,`price`) 
VALUES('$title','$description','$data','$created_date','$insert_time','$price')");
if($mysqlipre->affected_rows>0)	{
	...
	$mesage='<center><h3><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  <strong>Sorry </strong> Error in inserting Event.please try again!
                </div></h3></center>';
}	
}
}
...
<html lang="en">
    <head>
        ...
        <title>Young Yaa | Create Events</title>
                    ...
                    <?php echo $mesage ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                <h4 class="panel-title">Create Events</h4>
...
<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="created_date"  min="<?php echo $date ?>" placeholder="dd MM yy" id="datepicker" readonly>
