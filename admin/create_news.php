...
$insert=$mysqlipre->query("INSERT INTO `a7rtg_mynews`(`title`,`description`,`image`,`created_date`,`insertime`) 
VALUES('$title','$description','$data','$created_date','$insert_time')");
if($mysqlipre->affected_rows>0)	{
	...
	$mesage='<center><h3><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  <strong>Sorry </strong> Error in inserting News.please try again!
                </div></h3></center>';
}	
}
}
...
<html lang="en">
    <head>
        ...
        <title>Young Yaa | Create News</title>
