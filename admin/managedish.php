...
$mysqlipre->query("UPDATE `chef_dish_master` SET `active_flag`='activate',`inserttime`='$insert_time' WHERE dish_id='".$_POST['id']."'");
...
$mesage= '<center><h3><div class="alert alert-success alert-dismissible" role="alert">
                  ...
                  <strong> Approve Dish successfully.</strong>
                </div></h3></center>'; 
...
$mysqlipre->query("UPDATE `chef_dish_master` SET `active_flag`='deactivate',`inserttime`='$insert_time' WHERE dish_id='".$_POST['id']."'");
...
$mesage='<center><h3><div class="alert alert-success alert-dismissible" role="alert">
                  ...
                  <strong> Unapprove Dish successfully</strong>
                </div></h3></center>';
}
else
{
...
if(isset($_POST['delete'])){
	...
	$to= $_POST['email'];
$delete="DELETE FROM `chef_dish_master` WHERE `dish_id`='".$_POST['id']."'";
...
if(mail($to, $subject, $message, $headers))
{
                $mesage='<center><h3><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  <strong>  Dish  Deleted Successfully and Also Related Orders Deleted!</strong>
                </div></h3></center>';
	...
	$msg='<center><h3><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  <strong> Error in Deletion of dish, please try again!</strong>
                </div></h3></center>';
}
...
<html lang="en">
    <head>
        ...
        <title>Select Cook | Manage Dish</title>
...
echo"<center><b>No Dish Available</b></center>";	
                       ...
                       <!-- <p class="mb20"><a href="http://datatables.net/" target="_blank">DataTables</a> is a plug-in for the jQuery Javascript library. It is a highly flexible tool, based upon the foundations of progressive enhancement, and will add advanced interaction controls to any HTML table.</p>-->
                        ...
                        <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Manage Dish</h4>
...
echo "<center><b>No Category Available</b></center>";	
		...
		?>
						  ...
						  <input type="hidden" name="id" value="<?php echo $row['dish_id']; ?>">
						  <input type="hidden" name="name" value="<?php echo $row16['name']; ?>">
                           <input type="hidden" name="email" value="<?php echo $row16['email']; ?>">
						  

<?php if($row['active_flag']=='activate')
{
?>
<button  onclick="return confirm('Are you sure you want to Unapprove this Dish?')" type="submit" name="unapprove" class="btn btn-danger"><i class="fa fa-times"></i>UnApprove</button>
<?php } if($row['active_flag']=='deactivate')

{ ?>
<button  onclick="return confirm('Are you sure you want to Approve this User?')" type="submit" name="approve" class="btn btn-success"><i class="fa fa-check"></i>Approve</button>
			<?php }?>
			</form></td>
