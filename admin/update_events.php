...
$sel="SELECT * FROM ` a7rtg_myevents` WHERE `event_id`='".$_GET['id']."'";
...
$str2= rand();
$str3= $str.$str2;
$target = "/var/www/html/youngyaa.com.au/public_html/admin/images/"; 
...
$mysqlipre->query("UPDATE ` a7rtg_myevents` SET title='".$_POST['title']."',description='".$_POST['description']."',created_date='".$_POST['created_date']."', image='$data',price='$price', insertime='$insert_time' WHERE event_id='".$_GET['id']."'");
...
$mesage= '<center><h3><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  <strong>Event Not Updated.please try again!</strong>
                </div></h3></center>';
}
...
<html lang="en">
    <head>
        ...
        <title>Young Yaa | Update Events</title>
                    ...
                    <?php echo $mesage ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                <h4 class="panel-title">Update Events</h4>
...
<div class="form-group">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="text" name="price" class="form-control" value="<?php echo $row['price'];?>" placeholder="Please Enter price" />
                                                </div>
                                            </div>                                               
