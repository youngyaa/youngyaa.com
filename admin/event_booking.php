...
<html lang="en">
    <head>
        ...
        <title>Young Yaa | Event Booking</title>
                    ...
                    <div class="pageheader">
                        <div class="media">
                         ...
                         <?php echo $msg ?>
                    		...
                    		<?php  
$select="select * FROM `a7rtg_book_userevent`";
	$obj=$mysqlipre->query($select);
	if($obj->num_rows<=0){

$msg="<center><b>No Booking Event Available</b></center>";	
                       ...
                       <!-- <p class="mb20"><a href="http://datatables.net/" target="_blank">DataTables</a> is a plug-in for the jQuery Javascript library. It is a highly flexible tool, based upon the foundations of progressive enhancement, and will add advanced interaction controls to any HTML table.</p>-->
                        ...
                        <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Event Booking</h4>
...
$result15=$mysqlipre->query("SELECT * FROM ` a7rtg_myevents` WHERE `event_id`='".$row['event_id']."'");
...
$msg="<center><b>No Event Available</b></center>";	
				...
				?>
                                   <tr >
                                        ...
                                        <td style="text-align: center;"><?php echo $row16['username'];?></td>
										<td style="
     text-align: center;
...
<td style="
    word-break: break-word; text-align: center;
"><?php echo $roww['description'];?></td>

<td style="text-align: center;"><img class="img-circle" alt="No image" style="width:50px; height:50px; border-radius:50px;
                                             border:1px solid white;" src="<?php echo $roww['image'];?>"></td>
											 
											 <td style="
    word-break: break-word; text-align: center;
"><?php echo $roww['created_date'];?></td>
<td style="
    word-break: break-word; text-align: center;
"><?php echo $row['token'];?></td>
<td style="
    word-break: break-word; text-align: center;
