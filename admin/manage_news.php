...
if(isset($_POST['delete'])){
	...
	$to= $_POST['email'];
$delete="DELETE FROM `a7rtg_mynews` WHERE `news_id`='".$_POST['id']."'";
...
if($mysqlipre->affected_rows>0){
	...
	$msg='<center><h3><div class="alert alert-danger alert-dismissible" role="alert">
                  ...
                  <strong> Error in Deletion of News, please try again!</strong>
                </div></h3></center>';
}
...
<html lang="en">
    <head>
        ...
        <title>Young Yaa | Manage News</title>
                        ...
                        <div class="media">
                         ...
                         <?php echo $msg ?>
                          <?php echo $mesage ?>
                    		...
                    		<?php  
$select="select * FROM `a7rtg_mynews`";
	$obj=$mysqlipre->query($select);
	if($obj->num_rows<=0){

echo "<center><b>No News Available</b></center>";	
...
<td style="text-align: center;"><img class="img-circle" alt="No image" style="width:70px; height:70px; border-radius:70px;
 ...
 <td><a href="update_news.php?id=<?php echo $row['news_id'];?>" class="btn btn-round btn-info">Edit</a></td>
