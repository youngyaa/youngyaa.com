...
<div id="osm-plans-list-columns" class="osm-container">
	<?php
		...
		if (count($this->items))
		{
			echo OSMembershipHelperHtml::loadCommonLayout('common/pricingtable_plans.php', array('items' => $this->items, 'config' => $this->config, 'Itemid' => $this->Itemid, 'categoryId' => $this->categoryId, 'bootstrapHelper' => $this->bootstrapHelper));
		}
	?>
</div>