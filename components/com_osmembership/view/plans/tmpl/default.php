...
<div id="osm-plans-list-default" class="osm-container">
	<?php
		...
		if (count($this->items))
		{
			echo OSMembershipHelperHtml::loadCommonLayout('common/default_plans.php', array('items' => $this->items, 'config' => $this->config, 'Itemid' => $this->Itemid, 'categoryId' => $this->categoryId, 'bootstrapHelper' => $this->bootstrapHelper));
		}
