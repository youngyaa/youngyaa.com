 ...
 * View to edit
 */
class Bt_mediaViewTag extends JViewLegacy {
    ...
    protected function _prepareDocument() {
        ...
        } elseif (!$this->params->get('metadesc') && $this->item) {
            $this->document->setDescription(JFilterOutput::cleanText($this->item->description));
        } elseif (!$this->params->get('metadesc') && !$this->item && $this->params->get('menu-meta_description')) {
