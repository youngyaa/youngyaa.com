...
{
	$checkoutUrl = JRoute::_('index.php?option=com_eventbooking&task=checkout&Itemid='.$this->Itemid, false, 1) ;
}
else
{
	$checkoutUrl = JRoute::_('index.php?option=com_eventbooking&task=checkout&Itemid='.$this->Itemid, false) ;
}
?>
<table width="100%">
	<?php
